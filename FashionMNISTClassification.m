%% Data
%Data generated from fashion_mnist dataset, available at
%https://www.kaggle.com/datasets/zalando-research/fashionmnist. First row
%deleted

data = load('fashion-mnist_train.csv'); %Load data into script
...
writematrix(SuccessRateTotal,'C:\Users\markp\Google Drive\MSU\Mathematics\PHD\Terminal Embdedding\Matlab\fashion\SuccessRateTotal.csv')
writematrix(NonlinearityTotal,'C:\Users\markp\Google Drive\MSU\Mathematics\PHD\Terminal Embdedding\Matlab\fashion\NonlinearityTotal.csv')

%SuccessRateTotal = load('C:\Users\markp\Google Drive\MSU\Mathematics\PHD\Terminal Embdedding\Matlab\fashion\SuccessRateTotal.csv');
%NonlinearityTotal = load('C:\Users\markp\Google Drive\MSU\Mathematics\PHD\Terminal Embdedding\Matlab\fashion\NonlinearityTotal.csv');
